<template>
  <div class="container">
    <div v-if="!paidFor" style="justify-content: center;display: grid;margin-bottom: 2em;">
      <h1>Curso Jr - ${{ product.price }}</h1>

      <p>{{ product.description }}</p>

      <img width="400" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQFf48RkOt72eSZxHkaR8S9A5HCpX3GkK07jur6iEXfAPa6it9lNd-sSFKve-HmdnZlWzo&usqp=CAU" />
    </div>
...
export default {
  ...
  data: function() {
    return {
      ...
      product: {
        price: 59.99,
        description: "Para aquellos que tienen tiempo en la programacion",
        img: "./assets/lamp.jpg",        
      },
        icons: [
            'mdi-home',
