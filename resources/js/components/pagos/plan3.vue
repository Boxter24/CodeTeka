<template>
  <div class="container">
    <div v-if="!paidFor" style="justify-content: center;display: grid;margin-bottom: 2em;">
      <h1>Curso Senior - ${{ product.price }}</h1>

      <p>{{ product.description }}</p>

      <img width="400" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQZTDhF7slzdz0aVdGgCMxkzLq1nqbKLK1mdQEkMubabJSYco7jqExs9aq-ORrSJfKQz-A&usqp=CAU" />
    </div>
...
export default {
  ...
  data: function() {
    return {
      ...
      product: {
        price: 99.99,
        description: "Para aquellos expertos en la programacion",
        img: "./assets/lamp.jpg",        
      },
        icons: [
            'mdi-home',
