...
Route::apiResources(['programa' => 'API\ProgramaController']);
Route::get('programa', 'API\ProgramaController@index');
Route::get('/', 'API\ProgramaController@index');
...
Route::post('create-payment', function () {
    ...
    $item1 = new Item();
    $item1->setName('Plan Trainee')
        ->setCurrency('USD')
        ->setQuantity(1)
        ->setSku("123123") // Similar to `item_number` in Classic API
        ->setPrice(7.5);
    $item2 = new Item();
    $item2->setName('Plan Master')
        ->setCurrency('USD')
        ->setQuantity(5)
